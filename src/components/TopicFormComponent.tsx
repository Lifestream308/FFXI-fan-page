...
export default function TopicFormComponent({handleTopicSubmit, topicTitleRef, topicContentRef, user}:any) {
  return (
    <>
      ...
      { user &&
        <p className="mt-8 text-center">Author: {user.displayName}</p>
      }
      { !user &&
        <p className="mt-8 text-center">Not signed in. Topic author will be anonymous.</p>
      }
