...
export default function ModalComponent({setShowModal}:any) {
  return (
    <>
    <div className='fixed flex justify-center z-10 w-full h-full bg-gray-400 bg-opacity-40'>
        <div className='p-4 w-fit h-fit mt-12 text-center rounded-lg text-black bg-white shadow-2xl'>
            <p className='mb-8 text-5xl'>Alert Modal</p>
