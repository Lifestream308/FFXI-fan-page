...
export default function BGSection() {
  return (
    <>
      <div className="mt-6">
        <h2 className="text-lg underline">Website</h2>
        <p className="">This site was created using React, Typescript, Tailwind, and Firebase.</p>
      </div>
      <div className="mt-8">
        <h2 className="text-lg underline">Final Fantasy XI</h2>
        <p className="">This Final Fantasy was the first MMO in the series and goes back over 20 years! It has been succeeded by Final Fantasy XIV, but FFXI is still my personal favorite. Whenever I hear the music from FFXI I'm immediately filled with nostalgia.</p>
      </div>
