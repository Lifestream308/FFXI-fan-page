...
export default function RegisterComponent({register, usernameRef}:any) {
  ...
  return (
    <div className="my-4 flex flex-col items-center gap-4">
        ...
        <button onClick={() => register()} className="mt-4 px-4 py-2 w-fit text-white bg-blue-600 rounded-md" >Register <span className="py-1"><i className="bi bi-person-plus-fill"></i></span></button>
    </div>
  )
}
