    ...
    <>
      <div className="mt-6 px-6 sm:px-[5%] max-w-5xl">
        <div className="">
          ...
          <p className="leading-8 text-gray-700">This site was created using React, Typescript, Tailwind, and Firebase. This project also makes use of environment variables, react-router-dom, Redux Toolkit, and is hosted on Netlify. After more than 200 commits you can see the code for yourself on <a href="https://github.com/Lifestream308/FFXI-fan-page/tree/main" target="_blank" className="text-blue-700 underline">Github</a>. The job ability descriptions come from the official Final Fantasy XI Strategy Guide.</p>
      ...
      <section id="about" className='w-full mt-4 relative'>
          ...
          <div className="absolute top-[15%] left-[12%] p-1 rounded-lg bg-slate-50 bg-opacity-40">
              ...
              <p className="mt-6 text-gray-800">Enter the world of Vana'diel and team up with others if you want to survive</p>
          </div>
      </section>
    </>
  )
