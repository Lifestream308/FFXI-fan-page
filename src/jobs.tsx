...
// The blurb description is occasionally multiple lines, so maybe turn it into an array and then I can jobs.mnk.blurbDescription.map((line) => <p>{line}</p>)
